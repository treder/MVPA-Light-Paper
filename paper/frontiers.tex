...
\tiny
 \keyFont{ \section{Keywords:} toolbox, classification, decoding, regression, MVPA, SVM, Linear Discriminant Analysis, Logistic Regression, ridge regression, kernel methods, ensemble methods, regularization, cross-validation
