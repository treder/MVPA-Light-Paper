...
\begin{itemize}
    \item MVPA-Light: lda, logreg, svm, libsvm, liblinear, naive\_bayes.
    \item MATLAB: fitdiscm (LDA), lassglm (regularized Logistic Regression), 
\end{itemize}
...
Note that the results need to be taken with a pinch of salt. The implementations might implement different regularization strategies (e.g. MATLAB's logistic regression does not support logF or L2 regularization) 
